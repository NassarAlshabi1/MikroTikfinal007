...
void main() {
  ...
  group('🔒 SecureCredentialsStorage + MikroTik Integration', () {
    ...
    test('clearMikrotikCredentials يحذف كلمة المرور فقط', () async {
      ...
      await SecureCredentialsStorageContainer.instance.setOomolApiKey('oomol-key');
      ...
      expect(await SecureCredentialsStorageContainer.instance.getOomolApiKey(), 'oomol-key');
    });
